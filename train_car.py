...
class Dataset(torch_data.Dataset):
  ...
  def collate_fn(self, batch):
        batch = [batch for b in batch if batch is not None]
        print(batch)
    ...
    for epoch in range(0, epochs, 1):
        ...
        if epoch %  evaluation_interval == 0:
            ...
            if AP.mean() > max_mAP:
                ...
                max_mAP = AP.mean()
torch.save(model.state_dict(),'model_stateV1')
#entire_model = '/content/drive/MyDrive/KITTI/model/entire_model'
torch.save(model, 'entire_modelV1')
